	...
	<body>
		<div class="container-fluid">
			...
			<div class="tab-content white-bg">
				<div id="prices" class="tab-pane fade in active" style="height: 500px; overflow-y: auto; margin-left:15px;"><!-------- Prices -------->
															...
															<td class="col-sm-3"><b><?php echo $row["name"]; ?></b></td>
																<?php
																	...
																	echo "<td class='col-sm-2'>" . $row['price'] . "</td>";
																		$price=$row['price'];
																	echo "<td><input type=text name='p1' value='$price' class='input-price'/></td>";
																	echo "<td class='col-sm-2'>" . $row['price2'] . "</td>";
																		$price2=$row['price2'];
																	echo "<td><input type=text name=p2 value='$price2' class='input-price'/></td>";
														...
														<td class="col-sm-4"><b><?php echo $row["name"]; ?></b></td>
															<?php
																...
																echo "<td class='col-sm-3'>" . $row['price'] . "</td>";
																	$price=$row['price'];
																echo "<td class='col-sm-3'><input type=text name='p1' value='$price' class='input-price'/></td>";
																echo "<input type=hidden name=id value='".$row['id']."'/>";
																echo "<input type=hidden name=price onclick=alert() value='".$row['price']."'/>"; //TANGGALIN ITO
																echo "<td class='col-sm-1'><input type=submit value=Update class='btn btn-sm btn-success' /></td>";
																echo "</form>";
