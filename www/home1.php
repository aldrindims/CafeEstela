...
<html>
		...
		<body>
			...
			<div class="row" style="margin-top: 10px;">
				...
				<li class="active"><a  href="home1.php">Hot</a></li>
			...
			<div class="row m-l">
				<div class="tab-content col-md-8 white-bg" style="overflow-y: auto; max-height: 530px; overflow-x: hidden;">
					<div id="products" class="tab-pane fade in active">
						<?php
							$query = "SELECT * FROM tbl_product where category = 'hot' ORDER BY id ASC";
								...
								<tr>
									<td colspan="6" style="padding: 0;">
										<div style="max-height: 30em; overflow-y: auto;">
											<table class="table table-bordered table-condensed white-bg text-center" style="margin: 0; width: 100%; font-size: .95em;">
...
$size = $row['MaxSize'];
	...
	if ($row['name'] = 'Coffee Bean' && $row['size'] <= $size * .05 ){
		...
		$_SESSION['message'] = $name . ' is under 25%';
