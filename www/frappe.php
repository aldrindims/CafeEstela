...
<html>
		...
		<body>
			...
			<div class="row" style="margin-top: 10px;">
				...
				<li class="active"><a data-toggle="tab" href="frappe.php">Frappe</a></li>
			...
			<div class="row m-l">
				<div class="tab-content col-md-8 white-bg" style="overflow-y: auto; max-height: 530px; overflow-x: hidden;">
					<div id="products" class="tab-pane fade in active">
						<?php
							$query = "SELECT * FROM tbl_product where category = 'frappe' ORDER BY id ASC";
						...
						?>
												...
												<input type="hidden" id="type" value="drink"/>
																		...
																		<input type="button" name="add_to_cart_12oz" id="<?php echo $row["id"]; ?>" onclick = "al()" style="margin-top:0px; padding:3px;" class="btn btn-default form-control add_to_cart" value="Add to Cartss" />
