...
<html>
		...
		<body>
			...
			<div class="row" style="margin-top: 10px;">
				...
				<li ><a  href="Cold.php">Cold</a></li>
				<li ><a  href="frappe.php">Frappe</a></li>
				<li><a href="home2.php">Pasta</a></li>
				<li class="active"><a data-toggle="tab" href="main.php">Main</a></li>
			...
			<div class="row m-l">
				<div class="tab-content col-md-8 white-bg" style="overflow-y: auto; max-height: 530px; overflow-x: hidden;">
					<div id="products" class="tab-pane fade in active">
						<?php
							$query = "SELECT * FROM tbl_meals where category = 'main' ORDER BY name ASC";
							$result = mysqli_query ( $connect, $query );
							while ( $row = mysqli_fetch_array ( $result ) ) {
						?>
								<div class="col-sm-2 container-items" style="height: 130px;">
									<div class="items text-center">
										...
										<div class="row">
											<div class="col-sm-12 bottom-align">
												<font size="1em"><input type="radio" name="size" value="18oz" checked="checked" style="display: none" />
												<input type="text" name="quantity" id="quantity<?php echo $row["id"]; ?>" class="form-control text-center" value="1" /></font>
												<input type="hidden" id="type" value="meals"/>
												...
												<input type="button" name="add_to_cart_12oz" id="<?php echo $row["id"]; ?>" style="padding: 3px;" onClick = "al();" class="btn btn-default form-control add_to_cart" value="Add to Cart" />
								...
								<tr>
										...
										<div style="max-height: 30em; overflow-y: auto;">
											<table class="table table-bordered table-condensed white-bg text-center" style="margin: 0; width: 100%; font-size: 1em;">
												<?php
													...
													?>
																	<tr>
																		<td class="col-md-3" style="vertical-align: middle;"><?php  echo $values["product_name"]; ?></td>
																		...
																		<td class="col-md-2" style="vertical-align: middle;">
																			<button
																				class="minquant btn btn-warning btn-xs custom-button-quant"
																				...
																				class="addquant btn btn-warning btn-xs custom-button-quant"
																	...
																	$total = $total + ($values["product_quantity"] * $values["product_price"]);//eto problem
																		...
																		if($_SESSION['type'] == "group"){
																			...
																			$total = 	$total1 - ($total1 / $_SESSION['head']);
									...
									<tfoot>
										<tr>
											...
											<td colspan="3" style="text-align:right; vertical-align: middle;" class="text-left">DISCOUNT</td>
