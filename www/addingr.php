			...
			<div class="tab-content white-bg">
				<div id="stocks" class="tab-pane fade in active" style="height: 480px; overflow-y: auto; margin:0 0 0 15px; ">
					...
					<ul class="nav nav-pills nav-stacked col-md-2 affix">
						...
						<li><a href="deleteprod.php">Delete Meals</a></li>
					</ul>
...
<?php
												...
												$sql = "INSERT INTO tbl_ingredients (name, size, MaxSize) VALUES ('$name', '$size', '$max')";
														...
														echo "<p>Error adding new ingredient</p>";
														echo "</div>";
														}
												}
											?>
<form method="POST" class="form-horizontal" role="form">
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			<input type="number" min="0" name="size" placeholder="size" class="form-control"/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			<input type="number" min="0" name="max" placeholder="max quantity" class="form-control"/>
		</div>
	</div>

	<input type="submit" value="Submit" class="btn btn-md btn-success" onClick="return confirm('Are you sure you want to submit?');">
</form>
											</div>
										</div>
									</div>
