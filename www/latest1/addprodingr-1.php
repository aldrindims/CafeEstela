	...
	<body>
		<div class="container-fluid">
			...
			<ul class="nav nav-tabs navbar-left">
				...
				<li class="active"><a href="addprodingr.php#newmeals">Add Products</a></li>
			</ul>
			...
			<div class="tab-content white-bg">
				<div id="stocks" class="tab-pane fade in active" style="height: 500px; overflow-y: auto; margin:0 0 0 15px; ">
					...
					<ul class="nav nav-pills nav-stacked col-md-2">
						<li class="active"><a data-toggle="tab" href="#newprod">Add New Product</a></li>
...
if(isset($_POST['product']) && isset($_POST['price']) && $_POST['price2']){
	...
	$sql = "INSERT INTO tbl_product (name, price, price2) VALUES ('$product', '$price', '$price2')";
					...
					x.style.display = 'none';
														...
														<form method="POST" action="">
															...
															<div class="form-group col-md-12">
																...
																<div class="col-md-11">
																	<input type="text" name="product" placeholder="Product" required class="form-control"/>
																</div>
															</div>
													...
													<div class="form-group col-md-5">
														<span class="col-md-12 input-group">
															...
															<input type="text" name="price2" placeholder="Price2" required class="form-control"/>
														</span>
													</div>
													...
													<div class="form-group col-md-4">
														<span class="col-md-12 input-group">
															...
															<input type="text" name="box1" placeholder="BawasIngredient1" required class="form-control"/>
														</span>
													</div>
													...
													<div class="form-group col-md-1">
														...
														<div id="dThreshold2" style="display: none">
															...
															<div class="form-group col-md-4">
																<span class="col-md-12 input-group">
																	<span class="input-group-addon" id="sizing-addon1">Quantity</span>
																	<input type="text" name="box2" placeholder="BawasIngredient2" class="form-control"/>
																</span>
															</div>
														...
														<div id="dThreshold3" style="display: none">
															...
															<div class="form-group col-md-4">
																<span class="col-md-12 input-group">
																	<span class="input-group-addon" id="sizing-addon1">Quantity</span>
																	<input type="text" name="box3" placeholder="BawasIngredient3" class="form-control"/>
																</span>
															</div>
														...
														<div id="dThreshold4" style="display: none">
															...
															<div class="form-group col-md-4">
																<span class="col-md-12 input-group">
																	<span class="input-group-addon" id="sizing-addon1">Quantity</span>
																	<input type="text" name="box4" placeholder="BawasIngredient4" class="form-control"/>
																</span>
															</div>
														...
														<div id="dThreshold5" style="display: none">
															...
															<div class="form-group col-md-4">
																<span class="col-md-12 input-group">
																	<span class="input-group-addon" id="sizing-addon1">Quantity</span>
																	<input type="text" name="box5" placeholder="BawasIngredient5" class="form-control"/>
																</span>
															</div>
														...
														<div id="dThreshold6" style="display: none">
															...
															<div class="form-group col-md-4">
																<span class="col-md-12 input-group">
																	<span class="input-group-addon" id="sizing-addon1">Quantity</span>
																	<input type="text" name="box6" placeholder="BawasIngredient6" class="form-control"/>
																</span>
															</div>
														...
														<div id="dThreshold7" style="display: none">
															...
															<div class="form-group col-md-4">
																<span class="col-md-12 input-group">
																	<span class="input-group-addon" id="sizing-addon1">Quantity</span>
																	<input type="text" name="box7" placeholder="BawasIngredient7" class="form-control"/>
																</span>
															</div>
															...
															<div class="form-group col-md-1">
																	<span class="col-md-12 input-group">
																		<input type="button" onclick="show8();" value="+" class="btn btn-success" style="padding: 4px; margin-left: -2em;" />
														...
														<div id="dThreshold8" style="display: none">
															...
															<div class="form-group col-md-4">
																<span class="col-md-12 input-group">
																	<span class="input-group-addon" id="sizing-addon1">Quantity</span>
																	<input type="text" name="box8" placeholder="BawasIngredient8" class="form-control"/>
																</span>
															</div>
														...
														<div id="dThreshold9" style="display: none">
															...
															<div class="form-group col-md-4">
																<span class="col-md-12 input-group">
																	<span class="input-group-addon" id="sizing-addon1">Quantity</span>
																	<input type="text" name="box9" placeholder="BawasIngredient9" class="form-control"/>
																</span>
															</div>
														...
														<div id="dThreshold10" style="display: none">
															...
															<div class="form-group col-md-4">
																<span class="col-md-12 input-group">
																	<span class="input-group-addon" id="sizing-addon1">Quantity</span>
																	<input type="text" name="box11" placeholder="BawasIngredient11" class="form-control"/>
																</span>
															</div>
														...
														<div id="dThreshold12" style="display: none">
															...
															<div class="form-group col-md-4">
																<span class="col-md-12 input-group">
																	<span class="input-group-addon" id="sizing-addon1">Quantity</span>
																	<input type="text" name="box12" placeholder="12" class="form-control"/>
																</span>
															</div>
