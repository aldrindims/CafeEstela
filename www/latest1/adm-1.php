												...
												<tr>
													...
													<td class="col-sm-1">
														<?php
															...
															echo "<input type=text name=amount placeholder='Quantity'/> ";
															...
															echo "<input type=submit name=btn value=Restock class='btn btn-sm btn-success'/> ";
															echo "<input type=submit name= btn value=Undo class='btn btn-sm btn-warning'/> ";
															echo "</form>";
															echo "</td>";
														?>
												</tr>
