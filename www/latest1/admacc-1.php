										...
										<div class="panel-body">
											<div class="col-md-10 center-block form-group" style="background-color:white; width:100%;">
												<form action="" method="post" class="form-horizontal" role="form">
													...
													<div class="form-group">
														<label for="sec1" class="col-md-3 control-label">Security Quesion #1</label>
														<div class="col-md-9">
													...
													<div class="form-group">
														<label for="sec2" class="col-md-3 control-label">Security Quesion #2</label>
														<div class="col-md-9">
										...
										<div class="panel-body">
											<div class="col-md-10 center-block form-group" style="background-color:white; width:100%;">
												<form action="" method="post" class="form-horizontal" role="form">
											      ...
											      <input type="submit" value="Submit" name="register" class='btn btn-md btn-success'/>
											    </form>
											</div>
										</div>
