<?php
	...
	$query1 = "SELECT user_temp FROM `tbl_report_total` WHERE 1";
							...
							$row = mysqli_fetch_array($results);
								...
								echo $row["user_temp"];
								$_SESSION['employee'] = $row["user_temp"];
					...
					<div class="modal-dialog modal-sm" role="document">
	  					<div class="modal-content">
						    ...
						    <!-- <button type="button" class="btn btn-info pull-lg-left" id="backbutton" data-dismiss="modal" data-toggle="modal" data-target="#modal-1"><i class="fa fa-unlock-alt"></i>Back</button> -->
								 <input type="submit" class="btn btn-warning pull-lg-left" name="Submit" class="senior" id="submitbutton" onClick="return confirm('Are you sure you would like to submit this order?'); al();"/> 
					        </div>
	  					</div>
					</div>
					</div>
