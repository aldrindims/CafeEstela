	...
	<body>
		<div class="container-fluid">
			...
			<div class="tab-content white-bg">
				<div id="prices" class="tab-pane fade in active" style="height: 500px; overflow-y: scroll;"><!-------- Prices -------->
													...
													<td class="col-sm-3"><b><?php echo $row["name"]; ?></b></td>
														<?php
															...
															echo "<td class='col-sm-2'>" . $row['price2'] . "</td>";
																$price2=$row['price2'];
															echo "<td><input type=text name=p2 placeholder='$price2' class='input-price'/></td>";
