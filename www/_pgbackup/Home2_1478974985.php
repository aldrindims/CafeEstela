    ...
    <body>
        ...
        <div class="container" style="width:100%;">
            ...
            <div class="tab-content">
				...
				{
				?>
                            <div class="col-md-2" style="margin-top:12px; margin-left:5px; margin-right:5px;">
                                <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:5px; height:23%;" align="center">
                ...
                <div class="col-md-5" style="padding-left:15px; margin-top:12px;">
                <table class="table table-bordered" data-pg-collapsed>
                        <tr>
