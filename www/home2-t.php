<!DOCTYPE html>
 <html>
    ...
    <div style="text-align: right; margin-right: 3%; color: white">
    <?php
	session_start();
			...
			<div class="row m-l">
				...
				<div class="col-md-4 col-xs-12">
       				<div class="transaction-table">
       					<table id="removerow" class="table table-bordered table-condensed white-bg text-center" style="margin: 15px 0 0 0;">
							...
							<thead>
								...
								<image src="images/clear_cart.png" type="submit" name="clear" class="btn btn-xs" style="width:89px" onClick="return confirm('Are you sure you want to clear?');"/>
								...
								<tr>
									...
									<tfoot>
										<tr>
											...
											<td colspan="3" style="text-align:right;" class="text-left">DISCOUNT</td>
											<td>
												<?php 
													if (isset($_SESSION['type'])){
