...
<html>
		...
		<body>
			...
			<div class="row" style="margin-top: 10px;">
				...
				<li ><a data-toggle="tab"  href="sandwich.php">Sandwich</a></li>
				<li ><a  href="day.php">All Day</a></li>
				<li class="active"><a  href="add.php">Add Ons</a></li>
			</ul>
			...
			<div class="row m-l">
				<div class="tab-content col-md-8 white-bg">
					<div id="products" class="tab-pane fade in active">
						<?php
							$query = "SELECT * FROM tbl_add ORDER BY name ASC";
									...
									<div class="items text-center">
										...
										<div class="row">
											<div class="col-sm-12 bottom-align">
												...
												<input type="hidden" id="type" value="meals"/></font>
